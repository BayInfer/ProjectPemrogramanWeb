...
header('location:index.php');
    ...
    $email = $_SESSION['email']; // Mengambil email pengguna dari sesi
    $password = $_SESSION['password']; // Mengambil nama pengguna dari sesi
...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>Admin Kita | Dashboard</title>
		<link rel="stylesheet" href="../plugins/morris/morris.css">

        <!-- App css -->
        <link href="assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
        <link href="assets/css/core2.css" rel="stylesheet" type="text/css" />
                            ...
                            <div class="col-lg-4 col-md-4 col-sm-6">
                                <div class="card-box widget-box-one">
                                    ...
                                    <div class="wigdet-one-content">
                                        <p class="m-0 text-uppercase font-600 font-secondary text-overflow" title="Statistics" font-co>Categories Listed</p>
